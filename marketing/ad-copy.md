# Ad Copy — Dr. Michael Guida's Piano Studio

Marketing reference (not part of the website — this folder is outside `public/`, so it is never deployed).

---

## Serious Student — WARM version (primary, approved)

**Primary text:**

> Somewhere along the way, you told yourself you'd learn to play the piano one day.
>
...
>
> I'm Dr. Michael Guida, a Steinway Top Teacher here in Scottsdale, and helping adults finally do this is my favorite part of the job. There's nothing like watching someone who thought it was "too late" play something they never believed they could.
>
...
>
> • One-on-one lessons on my Steinway grand, in person or online
> • Get stuck between lessons? Text or send me a video any day, and I answer with the fix
> • A clear plan every week, so your practice always counts
> • A pace that will genuinely surprise you
>
> It takes commitment, and it's a real investment. But if you've been waiting for the right time and the right teacher, this is both.
>
> I only take a handful of students at a time, and I read every application personally. If this is finally your year, I'd love to hear from you.
>
> Apply below, and let's talk.

**Headline:** Finally Learn Piano, the Right Way
**Description:** Private coaching with a Steinway Top Teacher. By application.
...
**Alternate opening lines** (swap the first line to test a different hook):
- There's a piece of music you've always wished you could play.
- It's never too late to learn the piano. I promise you that.

---

## Serious Student — SHORT version (backup / pairs with the 60-sec video)

**Primary text:**

> Most people take a piano lesson once a week and forget it by Tuesday.
>
> My private students text me every day. Send me a video, I send one back. I'm a Steinway Top Teacher in Scottsdale, and I take only a handful of serious adults at a time.
>
> White-glove. Not cheap. The fastest way you'll ever learn.
>
> A few spots open. Apply below.

**Headline:** Learn From a Steinway Top Teacher
...
>
> I'm Dr. Michael Guida, a Steinway Top Teacher in Scottsdale with a doctorate in piano performance. I teach kids and adults, first-timers and advancing players. Every lesson is shaped around the person at the piano, your goals, your pace, and the music you actually want to play.
>
...
**Headlines:** Piano Lessons in Scottsdale · Kids & Adult Piano Lessons · Steinway Top Teacher · All Ages & Levels Welcome · Beginners to Advanced · Play Your First Song, Day One · In-Person or Online

**Descriptions:**
- Learn from a Steinway Top Teacher, DMA. Kids and adults, beginner to advanced.
...
## Campaign setup — quick reference

- **Page it runs from:** Dr. Michael Guida's Piano Studio (Facebook)
- **Pixel:** installed on the-serious-student page, dormant until `META_PIXEL_ID` is set;
  fires a `Lead` event on application submit.
- **Objective:** Leads, conversion location = Website, optimize for the `Lead` event.
  (If a brand-new pixel gets too little data, fall back to Traffic / Landing Page Views to start.)
- **Audience:** Scottsdale, Paradise Valley, Arcadia, North Scottsdale + radius. Age ~30–60.
  Broad works for local high-ticket; can layer interests (classical music, piano) if needed.
- **Budget:** start ~$15–20/day.
- **Schedule:** auto-start ~Aug 1 (a couple days before returning home Aug 2–3), so warm
  applications are waiting instead of a cold start, and no lead-fielding during vacation.
- **Creative:** launch with the masterclass photo (4:5 or 1:1). Swap in the 60-sec video later as a test.

## Rules (house style)
- No sentence-splitting em dashes.
- No income callouts ("if you make over $X") — violates Meta's personal-attributes policy.
- Premium implied through identity, not price shaming. "Not cheap / few spots / by application" does the filtering.
